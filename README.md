...
[6] Sandhiya S, Revathi S, Dr. B. Vinothkumar, "Design of Voltage Controlled Oscillator in 180 nm CMOS Technology," International Research Journal of Engineering and Technology (IRJET), vol. 5, no. 3, pp. 1347-1351, 2018.   
[7] Kunjan Devendra Shinde, "Design and implementation of 1 GHz Current Starved Voltage Controlled Oscillator (VCO) for PLL using 90nm CMOS technology," 2015 International Conference on Control, Instrumentation, Communication and Computational Technologies (ICCICCT), 2015.   
